...
variable "allowed_inbound_ip_addresses" {
  ...
  description = "Gets the agent IP from the environment - not needed"
}

variable "build_resource_group_name" {
  type    = string
  default = "${env("BUILD_RESOURCE_GROUP_NAME")}"
  description = "Gets the build resource group from the environment - probably not needed"
}

variable "capture_name_prefix" {
  type    = string
  default = "packer"
  description = "Name captured prefix - needed"
}

variable "client_cert_path" {
  type    = string
  default = "${env("ARM_CLIENT_CERT_PATH")}"
  description = "When authenticating with client cert, fetches from env - probably not needed"
}

variable "client_id" {
  type    = string
  default = "${env("ARM_CLIENT_ID")}"
  description = "When authenticating with service principal, fetches from env - probably needed"
}
...
variable "image_os" {
  type    = string
  default = "win10"
  description = "The OS version used - needed"
}

variable "image_version" {
  type    = string
  default = "dev"
  description = "Image version - needed"
}
...
variable "location" {
  ...
  description = "Fetches the location from the environment - not needed"
}

variable "object_id" {
  type    = string
  default = "${env("ARM_OBJECT_ID")}"
  description = "Fetches the ARM object id for something, probably needed"
}

variable "private_virtual_network_with_public_ip" {
  type    = string
  default = "${env("PRIVATE_VIRTUAL_NETWORK_WITH_PUBLIC_IP")}"
  description = "Fetches the public IP from the environment for some reason - probably not needed"
}

variable "resource_group" {
  type    = string
  default = "${env("ARM_RESOURCE_GROUP")}"
  description = "Fetches the resource group name from the environment - probably not needed"
}

variable "storage_account" {
  type    = string
  default = "${env("ARM_STORAGE_ACCOUNT")}"
  description = "Fetches the name of a storage account from the environment - probably needed"
}

variable "subscription_id" {
  type    = string
  default = "${env("ARM_SUBSCRIPTION_ID")}"
  description = "Fetches the name of a subscription ID from the environment - probably needed"
...
variable "temp_resource_group_name" {
  ...
  description = "The name of a temp resources group, fetched from the environment - probably needed"
...
variable "tenant_id" {
  ...
  description = "Fetches the tenant ID from the environment - probably needed"
...
variable "virtual_network_name" {
  ...
  description = "Fetches the virtual network name from the environment - probably not needed"
...
variable "virtual_network_resource_group_name" {
  ...
  description = "Fetches the virtual network resource group name from the environment - probably not needed"
}

variable "virtual_network_subnet_name" {
  type    = string
  default = "${env("VNET_SUBNET")}"
  description = "Fetches the virtual network subnet name from the environment - probably not needed"
...
variable "vm_size" {
  ...
  description = "VM size, probably not needed"
